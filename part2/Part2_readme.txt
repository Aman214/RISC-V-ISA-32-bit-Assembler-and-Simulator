...
8. The file Project.cpp contains both pipelined and unpipelined version.
9. The file pipe.cpp details some statistics such as stalls and instruction count.
